...
class Helpers:
    ...
    chosenParams = ["stanje","marka","model","godiste","kilometraza","kubikaza","snagaMotora"]
...
def readDatabaseToList():
    ...
    #cursor.execute("select * from dbo.CarAdds where cena >= 1000 and kubikaza <=7000")
    cursor.execute("select * from dbo.CarAdds where cena >= 1000  and kubikaza <=7000 order by godiste asc")
...
def Models(models):
    ...
    cursor.execute(f"select distinct model from dbo.CarAdds where marka = '{models}'")
...
def MarkaAutomobila():
    con = pyodbc.connect('DRIVER={SQL Server};'
                         ...
                         'Trusted_Connection=yes;')
    cursor = con.cursor()
    cursor.execute("select distinct marka from dbo.CarAdds")
...
def snagaMotora():
    con = pyodbc.connect('DRIVER={SQL Server};'
                         ...
                         'Trusted_Connection=yes;')
    cursor = con.cursor()
    cursor.execute("select distinct snagaMotora from dbo.CarAdds")
    allData = cursor.fetchall();
...
def kubikaza():
    con = pyodbc.connect('DRIVER={SQL Server};'
                         ...
                         'Trusted_Connection=yes;')
    cursor = con.cursor()
    cursor.execute("select distinct kubikaza from dbo.CarAdds")
    allData = cursor.fetchall();
...
#---------BEGIN-STANJE-----------------------------------
    cursor = con.cursor()
    cursor.execute("select distinct stanje from dbo.CarAdds")
    allData = cursor.fetchall();
...
# ---------BEGIN-MARKA-----------------------------------
    cursor.execute("select marka, Avg(cena) from dbo.CarAdds GROUP BY marka Order by Avg(cena) asc")
    allData = cursor.fetchall();
...
# ---------BEGIN-MODEL-----------------------------------
    cursor.execute("select model, Avg(cena) from dbo.CarAdds GROUP BY model Order by Avg(cena) asc")
    allData = cursor.fetchall();
...
# ---------BEGIN-KILOMETRAZA-----------------------------------
    cursor.execute("select distinct kilometraza from dbo.CarAdds")
    allData = cursor.fetchall();
...
# ---------BEGIN-GODISTE-----------------------------------
    cursor.execute("select distinct godiste from dbo.CarAdds")
    allData = cursor.fetchall();
...
def encodeParamVales():
        ...
        # ---------BEGIN-MARKA-----------------------------------
        cursor.execute("select marka, Avg(cena) from dbo.CarAdds group by marka")
        allData = cursor.fetchall();
        ...
        # ---------BEGIN-MODEL-----------------------------------
        cursor.execute("select model ,  Avg(cena) from dbo.CarAdds group by model")
        allData = cursor.fetchall();
        ...
        # ---------BEGIN-KAROSERIJA-----------------------------------
        cursor.execute("select distinct karoserija from dbo.CarAdds")
        allData = cursor.fetchall();
...
def encodeParamValuesKNN():
    ...
    # ---------BEGIN-MODEL-----------------------------------
    cursor.execute("select model from dbo.CarAdds")
    allData = cursor.fetchall();
